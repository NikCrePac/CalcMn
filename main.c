...
int main()
{
    ...
    printf("--------------------------------------------------\n");
    //Пункты меню
    printf("1. Ввод множества\n");
    printf("2. Вывод множеста\n");
    printf("3. Проверка принадлежности множеству\n");
    printf("4. Вывод всех множеств\n");
    printf("5. Проверка принадлежности всем множествам\n");
    printf("6. Задать универсум\n");
    printf("7. Найти пересечение множеств\n");
    printf("0. Выход\n");
    ...
    switch(menu)    //Меню 1
    {
        ...
        case 6:
            ...
            break;
        case 7:
            printf("Найти пересечение множеств\n");
            for(int i = 0; i < 5; i++)
            {
