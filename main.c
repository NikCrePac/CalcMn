...
int main()
{
    ...
    int menu_sc1 = 0;   //Пременная для выбора пункта в меню 1
    int menu_sc2 = 0;   //Пременная для выбора пункта в меню 2
    int menu_sc3 = 0;   //Пременная для выбора пункта в меню 3
    int menu_sc4 = 0;   //Пременная для выбора пункта в меню 9
