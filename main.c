...
int main()
{
    ...
    int menu_sc1 = 0;   //Переменная для выбора пункта в меню 1
    int menu_sc2 = 0;   //Переменная для выбора пункта в меню 2
    int menu_sc3 = 0;   //Переменная для выбора пункта в меню 3
    int menu_sc4 = 0;   //Переменная для выбора пункта в меню 9
    ...
    int arr_to_combine1[] = {0, 0, 0, 0, 0};    //Промежуточный массив 1 для объединения
    int arr_to_combine2[] = {0, 0, 0, 0, 0};    //Промежуточный массив 2 для объединения
